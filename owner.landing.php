...
<style>
    .info-box {
        min-height: 65px; /* Reduced box height */
        transition: all 0.2s;
    }
    .info-box:hover {
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="row g-2"> <!-- Reduced gutter spacing -->
            <!-- First Name -->
            <div class="col-md-4"> <!-- Narrower column -->
                <div class="border rounded p-2 h-100 info-box"> <!-- Reduced padding -->
                    <label class="form-label text-muted small mb-0">First Name</label> <!-- Smaller margin -->
                    <p class="mb-0 fs-6"> <!-- Smaller font -->
            ...
            <!-- Last Name -->
            <div class="col-md-4">
                <div class="border rounded p-2 h-100 info-box">
            ...
            <div class="col-md-4">
                <div class="border rounded p-2 h-100 info-box">
                    ...
                    <p class="mb-0 fs-6">
                        <?= htmlspecialchars($_SESSION['phone'] ?? 'N/A') ?>
                    </p>
                </div>
            </div>

            <!-- Email Address -->
            <div class="col-md-12 mt-2"> <!-- Full width with top margin -->
                <div class="border rounded p-2 info-box">
                    <label class="form-label text-muted small mb-0">Email</label>
                    <p class="mb-0 fs-6 text-truncate">
