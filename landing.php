...
<body>
    ...
    <main class="container-fluid m-0 p-0">
        <div class="d-flex flex-column d-md-none d-lg-none gradient-success vh-100 m-0 p-4">
            <img src="images/rb logo white.png" alt="logo" style="width: 50px; height: 50px;" class="ms-3 mt-2 mb-2">
            <div class="mt-auto">
                <h1 class="display-1 fw-bold  mt-5 pb-3">Your Gadgets,<br> Your Way</h1>
                <p class="lead">
                ...
                <div class="justify-content-md-start mb-4 mb-lg-3 mt-4">
                    <a type="button" class="btn btn-success2 btn-md px-4 me-md-2 rounded-4" href="signup.php">Start Renting</a>
                    <button type="button" class="btn btn-success2 btn-md px-4 me-md-2 rounded-4">List Your Gadget</button>
                </div>
            </div>
        </div>
        <div class="row container-fluid d-none d-md-block d-lg-block p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-5 border shadow-lg">
            <div class="col-md-6 col-lg-6 p-3 p-lg-5 pt-lg-3">
        ...
        <div class="container-fluid bg-body d-none d-md-block d-lg-block ">
            <div class="row px-4">
        ...
        <div class="gradient container-fluid pt-5 d-none d-md-block d-lg-block ">
    ...
    <footer class="container-fluid d-none d-md-block d-lg-block ">
        <div class="row m-5">
            <div class="col">
