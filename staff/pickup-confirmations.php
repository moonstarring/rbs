...
$deviceDetails = $staff->getDeviceDetails($productId);
$specificRental = $staff->getSpecificRental($rentalId, $_SESSION['id']);
...
<head>
    ...
    <style>
        ...
        /* Updated styles for centered content */
        .main-content { 
            max-width: 1800px;
            margin: 0 auto;
            padding: 20px;
