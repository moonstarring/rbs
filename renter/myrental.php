...
<head>
    ...
    <style>
        .profile-picture { width: 100px; height: 100px; object-fit: cover; }
        .verification-badge { font-size: 0.75rem; }
        .accordion-button:not(.collapsed) { background-color: #198754; color: white; }
        .nav-tabs .nav-link.active { border-color: #198754; color: #198754; }
        .form-control:focus { border-color: #198754; box-shadow: 0 0 0 0.25rem rgba(25, 135, 84, 0.25); }
        .profile-info-card { transition: transform 0.2s ease; }
        .profile-info-card:hover { transform: translateY(-2px); }
        .info-label { font-size: 0.9rem; margin-bottom: 0.3rem; }
        .verified-info div { margin-bottom: 1.2rem; padding-bottom: 0.5rem; border-bottom: 1px solid #dee2e6; }
    </style>
</head>
<body>
